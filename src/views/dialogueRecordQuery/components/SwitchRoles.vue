  ...
  <div class="app-container">
    ...
    >
     <el-form-item   
      label-width="40px"
      prop="region">
        <el-select v-model="listSearchKey.region" clearable style="width: 120px" placeholder="请选择类别">
          <el-option v-for="(item,index) in listSearchOptions" :key="index" :label="item.name" :value="item.value"/>
        </el-select>
      </el-form-item>
